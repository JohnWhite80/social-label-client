 ...
 */
public class WheelView_bir extends View {
	/** Scrolling duration */
	...
	private List<OnWheelScrollListener_bir> scrollingListeners = new LinkedList<OnWheelScrollListener_bir>();

	/**
	 * Constructor
	 */
	public WheelView_bir(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * Constructor
	 */
	public WheelView_bir(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
	}
	 ...
	 * Constructor
	 */
	public WheelView_bir(Context context) {
		super(context);
		initData(context);
	}
	 ...
	 * @param scrollListener the listener 
	 */
	public void addScrollingListener(OnWheelScrollListener_bir scrollListener) {
		scrollingListeners.add(scrollListener);
	}
	 ...
	 * @param listener the listener
	 */
	public void removeScrollingListener(OnWheelScrollListener_bir listener) {
	...
	protected void notifyScrollingListenersAboutStart() {
		for (OnWheelScrollListener_bir listener : scrollingListeners) {
	...
	private void initResourcesIfNecessary() {
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.wheel_val_bir);
		}
		...
		setBackgroundResource(R.drawable.wheel_bg_bir);
	}
