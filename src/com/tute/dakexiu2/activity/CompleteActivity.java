...
import com.tute.clientHelp.ThreadComplete;
...
public class CompleteActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		girle=(RadioButton)findViewById(R.id.girl_id);
		...
		class CompleteTask extends AsyncTask<String, Void, String> {
