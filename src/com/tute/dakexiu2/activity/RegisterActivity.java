...
public class RegisterActivity extends BasicActivity implements OnFocusChangeListener{
	...
	boolean boolEmail,boolPasw,boolNikeName;
	...
	protected  void finishRegist() {	
		...
		if((boolEmail&&boolPasw&&boolNikeName)){
			...
			if(checkNetworkState()){
				String url = "http://10.0.2.2:8080/server/api/register";
...
//				hp.setHeader("Content-Type", "application/json");
		...
		protected void onPostExecute(String result) {
			if("register success".equals(result)){
				...
				LocalStorage.saveString(RegisterActivity.this, "userPassword", password);
				LocalStorage.saveString(RegisterActivity.this, "userNikeName", name);				
				
				Intent intent=new Intent(RegisterActivity.this,CompleteActivity.class);
				startActivity(intent);				
			}else if("Email Used".equals(result)){
